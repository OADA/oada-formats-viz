...
module.exports = {
  "oada-formats": {
    ...
    "oada": {
      ...
      "crop-type": {
        "description": "crop-type is a data type that holds a string representing the name of a type of crop. It has the same known values as the possible properties in crop-index.",
        "type": "string",
        "known": [
          "corn",
          "soybeans",
